...
module.exports = function(sequelize, DataTypes) {
  var user_role_base_department = sequelize.define('user_role_base_department', {
    ...
    sequelize,tableName: 'user_role_base_department',timestamps: false,indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" },]}]
  });
  return user_role_base_department;
};        
