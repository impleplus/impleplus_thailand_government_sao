...
module.exports = function(sequelize, DataTypes) {
  var province_electricity_branch = sequelize.define('province_electricity_branch', {
    ...
    sequelize, tableName: 'province_electricity_branch', timestamps: false, indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" }]}]
  });
  return province_electricity_branch;
};